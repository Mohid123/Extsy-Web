...
const CreateNewEventModal = (Props:any) => {
  ...
  const buttonItemLayout =
    ...
    return ( 
        ...
        //   onCancel={hideEventModal}
          className="position-relative top-modal"
        >
            ...
            >
              ...
              <Form.Item
                rules={[
                  {
                    required: true,
                    message: "Please provide a meet link for the event",
                  },
                ]}
                label="Meet link"
                name="Meet link"
              ...
              <Form.Item
                rules={[
                  {
                    required: true,
                    message: "Please provide a venue for the event",
                  },
                ]}
                label="Venue"
                name="Venue"
