        ...
        <div className="userStoryCard">
            ...
            <div className=" ">
                <Row  gutter={{ xs: 24, sm: 24, md: 24, lg: 8 }} className="justify-content-end">
                    ...
                    <h6 className="textColor mt-3">212</h6>
                    </div>
                    <div className="mt-3">
                ...
                <div className="d-flex  ">
                        <img src={AvatarImage} alt="" style={{width:'39px',marginRight:'10px',marginLeft:'10px', marginTop:'30px'}}/>
                                ...
                                <div>
                             <h4 className="mt-5 textColor pb-0">Ali Raza</h4>
                            <h6 className="textColor py-0">UserName</h6>
                            </div>
                            
                            <Button   ghost style={{marginLeft:'10px', borderRadius:'10px',color:'#fff',marginTop:'70px'}}>
                            Follow
    </Button>
                          
                    </div>
                    <p className="textColor ms-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit ut aliquam, purus sit...</p>
                    </div>
...
<div className="d-flex ms-5 my-3">
    <h6 style={{color:'#7C167D'}}>View all comments</h6>
